...
// Fracture: fall → leg (ground slow/jump), side wall → arm (switch wind-up + random fire delay). Levels I–III.
MACRO_CONFIG_INT(HoFracture, ho_fracture, 1, 0, 1, CFGFLAG_SERVER, "Enable fracture effects; new fractures only while ho_falldamage is on (0=off, 1=on)")
MACRO_CONFIG_INT(HoFractureLegSpeed, ho_fracture_leg_speed, 55, 10, 100, CFGFLAG_SERVER, "Leg fracture III ground speed percent of normal (I/II scale up to this)")
MACRO_CONFIG_INT(HoFractureLegJump, ho_fracture_leg_jump, 55, 10, 100, CFGFLAG_SERVER, "Leg fracture III jump impulse percent of normal (I/II scale up to this)")
MACRO_CONFIG_INT(HoFractureArmSwitchMs, ho_fracture_arm_switch_ms, 600, 0, 5000, CFGFLAG_SERVER, "Arm fracture III weapon-switch wind-up (ms) for +nextweapon/+weaponN; I/II scale")
MACRO_CONFIG_INT(HoFractureArmFireMsMin, ho_fracture_arm_fire_ms_min, 80, 0, 5000, CFGFLAG_SERVER, "Arm fracture extra fire delay min (ms), random roll then scaled by level")
MACRO_CONFIG_INT(HoFractureArmFireMsMax, ho_fracture_arm_fire_ms_max, 280, 0, 5000, CFGFLAG_SERVER, "Arm fracture extra fire delay max (ms), random roll then scaled by level")

// Gojo (ho_gojo): shotgun techniques 苍/赫/茈 + 无下限 toggle
MACRO_CONFIG_INT(HoGojoChargeTicksMin, ho_gojo_charge_ticks_min, 12, 1, 200, CFGFLAG_SERVER, "Gojo min hold ticks before release casts")
MACRO_CONFIG_INT(HoGojoChargeTicksMax, ho_gojo_charge_ticks_max, 60, 1, 500, CFGFLAG_SERVER, "Gojo hold ticks for full charge size")
MACRO_CONFIG_INT(HoGojoChargeSpeedMin, ho_gojo_charge_speed_min, 25, 5, 100, CFGFLAG_SERVER, "Move speed percent at full Gojo charge")
MACRO_CONFIG_INT(HoGojoBlueRadiusMin, ho_gojo_blue_radius_min, 48, 8, 500, CFGFLAG_SERVER, "苍 radius at min charge (px)")
MACRO_CONFIG_INT(HoGojoBlueRadiusMax, ho_gojo_blue_radius_max, 140, 8, 800, CFGFLAG_SERVER, "苍 radius at full charge (px)")
MACRO_CONFIG_INT(HoGojoBluePull, ho_gojo_blue_pull, 18, 0, 200, CFGFLAG_SERVER, "苍 pull strength (tenths of px/tick)")
MACRO_CONFIG_INT(HoGojoBlueControlSpeed, ho_gojo_blue_control_speed, 14, 1, 100, CFGFLAG_SERVER, "苍 cursor-follow speed (px/tick)")
MACRO_CONFIG_INT(HoGojoBlueLife, ho_gojo_blue_life, 120, 10, 1000, CFGFLAG_SERVER, "苍 lifetime in ticks")
MACRO_CONFIG_INT(HoGojoBlueDamage, ho_gojo_blue_damage, 1, 0, 10000, CFGFLAG_SERVER, "苍 independent-HP damage per tick")
MACRO_CONFIG_INT(HoGojoBlueDamageDelay, ho_gojo_blue_damage_delay, 4, 1, 50, CFGFLAG_SERVER, "苍 damage interval ticks")
MACRO_CONFIG_INT(HoGojoRedRadiusMin, ho_gojo_red_radius_min, 40, 8, 500, CFGFLAG_SERVER, "赫 radius at min charge (px)")
MACRO_CONFIG_INT(HoGojoRedRadiusMax, ho_gojo_red_radius_max, 120, 8, 800, CFGFLAG_SERVER, "赫 radius at full charge (px)")
MACRO_CONFIG_INT(HoGojoRedSpeed, ho_gojo_red_speed, 14, 1, 100, CFGFLAG_SERVER, "赫 projectile speed (px/tick)")
MACRO_CONFIG_INT(HoGojoRedLife, ho_gojo_red_life, 80, 10, 1000, CFGFLAG_SERVER, "赫 lifetime ticks")
MACRO_CONFIG_INT(HoGojoRedPush, ho_gojo_red_push, 22, 0, 200, CFGFLAG_SERVER, "赫 push strength (tenths)")
MACRO_CONFIG_INT(HoGojoRedDamage, ho_gojo_red_damage, 8, 0, 10000, CFGFLAG_SERVER, "赫 independent-HP damage")
MACRO_CONFIG_INT(HoGojoPurpleRadius, ho_gojo_purple_radius, 100, 8, 800, CFGFLAG_SERVER, "茈 fixed radius (px)")
MACRO_CONFIG_INT(HoGojoPurpleSpeed, ho_gojo_purple_speed, 18, 1, 100, CFGFLAG_SERVER, "茈 projectile speed (px/tick)")
MACRO_CONFIG_INT(HoGojoPurpleLife, ho_gojo_purple_life, 70, 10, 1000, CFGFLAG_SERVER, "茈 lifetime ticks")
MACRO_CONFIG_INT(HoGojoPurplePush, ho_gojo_purple_push, 28, 0, 200, CFGFLAG_SERVER, "茈 push strength (tenths)")
MACRO_CONFIG_INT(HoGojoPurpleDamage, ho_gojo_purple_damage, 25, 0, 10000, CFGFLAG_SERVER, "茈 independent-HP damage")
MACRO_CONFIG_INT(HoGojoPurpleMergeTicks, ho_gojo_purple_merge_ticks, 28, 5, 200, CFGFLAG_SERVER, "茈 赫+苍 merge animation ticks above head")
